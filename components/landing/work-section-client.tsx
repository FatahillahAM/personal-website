...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      ...
      {project.external && (
        <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-mono text-foreground/70 group-hover:text-foreground transition-colors">
          Watch on YouTube
...
export function WorkSectionClient({ projects }: { projects: Project[] }) {
  const [isVisible, setIsVisible] = useState(false);
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-24">
          ...
          <p className="text-muted-foreground max-w-sm">
            A small selection of recent work across automation, design, and
            video. More available on request.
          </p>
        </div>
